...
public class RefillsSpawners : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        {
            Vector3 randomSpawnPosition = new Vector3(Random.Range(-22.8f, 22.5f), 1.5f, Random.Range(-20.8f, 18.9f));
        ...
        {
            Vector3 randomSpawnPosition = new Vector3(Random.Range(-22.8f, 22.5f), 2f, Random.Range(-20.8f, 18.9f));
